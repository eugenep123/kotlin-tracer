...
data class Color(val red: Double, val green: Double, val blue: Double) {
    ...
    inline operator fun plus(rhs: Color): Color =
        Color(red + rhs.red, green + rhs.green, blue + rhs.blue)

    inline operator fun minus(rhs: Color): Color =
        Color(red - rhs.red, green - rhs.green, blue - rhs.blue)

    inline operator fun times(d: Double): Color =
        Color(red * d, green * d, blue * d)

    inline operator fun times(rhs: Color): Color =
        Color(red * rhs.red, green * rhs.green, blue * rhs.blue)
